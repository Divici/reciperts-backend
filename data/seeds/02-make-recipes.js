...
const ingredients = [
    {ingredient_name: 'Cheese', ingredient_unit: 'lbs', quantity: 2},
    {ingredient_name: 'Chicken', ingredient_unit: 'ozs', quantity: 8},
    {ingredient_name: 'Soy Sauce', ingredient_unit: 'ozs', quantity: 7},
    {ingredient_name: 'Pasta', ingredient_unit: 'lbs', quantity: 6},
    {ingredient_name: 'Broccoli', ingredient_unit: 'grams', quantity: 5},
    {ingredient_name: 'Peppers', ingredient_unit: 'grams', quantity: 4},
]
